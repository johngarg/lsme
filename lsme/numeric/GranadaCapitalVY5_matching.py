...
class GranadaVY5MatchingResult(matchingresult.GenericMatchingResult):
    def __init__(self, name='VY5'):
        super().__init__(name)
        self.MVY5 = 1
        self.gVY5 = np.ones((3, 3))
        self.gVY5bar = np.ones((3, 3))
        self.exotic_params = ['MVY5', 'gVY5', 'gVY5bar']
        self.nonvanishing = ['alphaOqu1', 'alphaOqu1bar', 'alphaOqu8', 'alphaOqu8bar']
    ...
    def alphaOqu1(self, mif1,mif2,mif3,mif4):
        return 1/6 * (self.MVY5)**(-2) * self.gVY5[mif3,mif1] * self.gVY5bar[mif4,mif2]

    def alphaOqu1bar(self, mif1,mif2,mif3,mif4):
        return 1/6 * (self.MVY5)**(-2) * self.gVY5[mif4,mif2] * self.gVY5bar[mif3,mif1]

    def alphaOqu8(self, mif1,mif2,mif3,mif4):
        return 1/4 * (self.MVY5)**(-2) * self.gVY5[mif3,mif1] * self.gVY5bar[mif4,mif2]

    def alphaOqu8bar(self, mif1,mif2,mif3,mif4):
        return 1/4 * (self.MVY5)**(-2) * self.gVY5[mif4,mif2] * self.gVY5bar[mif3,mif1]
