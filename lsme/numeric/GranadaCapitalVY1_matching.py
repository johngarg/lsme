...
class GranadaVY1MatchingResult(matchingresult.GenericMatchingResult):
    def __init__(self, name='VY1'):
        super().__init__(name)
        self.MVY1 = 1
        self.gVY1 = np.ones((3, 3))
        self.gVY1bar = np.ones((3, 3))
        self.exotic_params = ['MVY1', 'gVY1', 'gVY1bar']
        self.nonvanishing = ['alphaOqd1', 'alphaOqd1bar', 'alphaOqd8', 'alphaOqd8bar']
    ...
    def alphaOqd1(self, mif1,mif2,mif3,mif4):
        return 1/6 * (self.MVY1)**(-2) * self.gVY1[mif3,mif1] * self.gVY1bar[mif4,mif2]

    def alphaOqd1bar(self, mif1,mif2,mif3,mif4):
        return 1/6 * (self.MVY1)**(-2) * self.gVY1[mif4,mif2] * self.gVY1bar[mif3,mif1]

    def alphaOqd8(self, mif1,mif2,mif3,mif4):
        return 1/4 * (self.MVY1)**(-2) * self.gVY1[mif3,mif1] * self.gVY1bar[mif4,mif2]

    def alphaOqd8bar(self, mif1,mif2,mif3,mif4):
        return 1/4 * (self.MVY1)**(-2) * self.gVY1[mif4,mif2] * self.gVY1bar[mif3,mif1]
