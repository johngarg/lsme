...
class GranadaVU2MatchingResult(matchingresult.GenericMatchingResult):
    def __init__(self, name='VU2'):
        super().__init__(name)
        self.MVU2 = 1
        self.gedVU2 = np.ones((3, 3))
        self.gedVU2bar = np.ones((3, 3))
        self.glqVU2 = np.ones((3, 3))
        self.glqVU2bar = np.ones((3, 3))
        self.exotic_params = ['MVU2', 'gedVU2', 'gedVU2bar', 'glqVU2', 'glqVU2bar']
        self.nonvanishing = ['alphaOed', 'alphaOedbar', 'alphaOledq', 'alphaOledqbar', 'alphaOlq1', 'alphaOlq1bar', 'alphaOlq3', 'alphaOlq3bar']
    ...
    def alphaOed(self, mif1,mif2,mif3,mif4):
        return -1 * (self.MVU2)**(-2) * self.gedVU2[mif1,mif4] * self.gedVU2bar[mif2,mif3]

    def alphaOedbar(self, mif1,mif2,mif3,mif4):
        return -1 * (self.MVU2)**(-2) * self.gedVU2[mif2,mif3] * self.gedVU2bar[mif1,mif4]
    ...
    def alphaOledq(self, mif1,mif2,mif3,mif4):
        return 2 * (self.MVU2)**(-2) * self.gedVU2bar[mif2,mif3] * self.glqVU2[mif1,mif4]

    def alphaOledqbar(self, mif1,mif2,mif3,mif4):
        return 2 * (self.MVU2)**(-2) * self.gedVU2[mif2,mif3] * self.glqVU2bar[mif1,mif4]
    ...
    def alphaOlq1(self, mif1,mif2,mif3,mif4):
        return -1/2 * (self.MVU2)**(-2) * self.glqVU2[mif1,mif4] * self.glqVU2bar[mif2,mif3]

    def alphaOlq1bar(self, mif1,mif2,mif3,mif4):
        return -1/2 * (self.MVU2)**(-2) * self.glqVU2[mif2,mif3] * self.glqVU2bar[mif1,mif4]
