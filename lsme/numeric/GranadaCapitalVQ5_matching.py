...
class GranadaVQ5MatchingResult(matchingresult.GenericMatchingResult):
    def __init__(self, name='VQ5'):
        super().__init__(name)
        self.MVQ5 = 1
        self.gdlVQ5 = np.ones((3, 3))
        self.gdlVQ5bar = np.ones((3, 3))
        self.geqVQ5 = np.ones((3, 3))
        self.geqVQ5bar = np.ones((3, 3))
        self.guqVQ5 = np.ones((3, 3))
        self.guqVQ5bar = np.ones((3, 3))
        self.exotic_params = ['MVQ5', 'gdlVQ5', 'gdlVQ5bar', 'geqVQ5', 'geqVQ5bar', 'guqVQ5', 'guqVQ5bar']
        self.nonvanishing = ['alphaOld', 'alphaOldbar', 'alphaOledq', 'alphaOledqbar', 'alphaOqe', 'alphaOqebar', 'alphaOqu1', 'alphaOqu1bar', 'alphaOqu8', 'alphaOqu8bar']
    ...
    def alphaOld(self, mif1,mif2,mif3,mif4):
        return (self.MVQ5)**(-2) * self.gdlVQ5[mif4,mif2] * self.gdlVQ5bar[mif3,mif1]

    def alphaOldbar(self, mif1,mif2,mif3,mif4):
        return (self.MVQ5)**(-2) * self.gdlVQ5[mif3,mif1] * self.gdlVQ5bar[mif4,mif2]
    ...
    def alphaOledq(self, mif1,mif2,mif3,mif4):
        return 2 * (self.MVQ5)**(-2) * self.gdlVQ5bar[mif3,mif1] * self.geqVQ5[mif2,mif4]

    def alphaOledqbar(self, mif1,mif2,mif3,mif4):
        return 2 * (self.MVQ5)**(-2) * self.gdlVQ5[mif3,mif1] * self.geqVQ5bar[mif2,mif4]
    ...
    def alphaOqe(self, mif1,mif2,mif3,mif4):
        return (self.MVQ5)**(-2) * self.geqVQ5[mif4,mif2] * self.geqVQ5bar[mif3,mif1]

    def alphaOqebar(self, mif1,mif2,mif3,mif4):
        return (self.MVQ5)**(-2) * self.geqVQ5[mif3,mif1] * self.geqVQ5bar[mif4,mif2]
    ...
    def alphaOqu1(self, mif1,mif2,mif3,mif4):
        return 2/3 * (self.MVQ5)**(-2) * self.guqVQ5[mif3,mif1] * self.guqVQ5bar[mif4,mif2]

    def alphaOqu1bar(self, mif1,mif2,mif3,mif4):
        return 2/3 * (self.MVQ5)**(-2) * self.guqVQ5[mif4,mif2] * self.guqVQ5bar[mif3,mif1]

    def alphaOqu8(self, mif1,mif2,mif3,mif4):
        return -2 * (self.MVQ5)**(-2) * self.guqVQ5[mif3,mif1] * self.guqVQ5bar[mif4,mif2]

    def alphaOqu8bar(self, mif1,mif2,mif3,mif4):
        return -2 * (self.MVQ5)**(-2) * self.guqVQ5[mif4,mif2] * self.guqVQ5bar[mif3,mif1]
