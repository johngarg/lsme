...
class GranadaVXMatchingResult(matchingresult.GenericMatchingResult):
    def __init__(self, name='VX'):
        super().__init__(name)
        self.MVX = 1
        self.gVX = np.ones((3, 3))
        self.gVXbar = np.ones((3, 3))
        self.exotic_params = ['MVX', 'gVX', 'gVXbar']
        self.nonvanishing = ['alphaOlq1', 'alphaOlq1bar', 'alphaOlq3', 'alphaOlq3bar']
    ...
    def alphaOlq1(self, mif1,mif2,mif3,mif4):
        return -3/8 * (self.MVX)**(-2) * self.gVX[mif1,mif4] * self.gVXbar[mif2,mif3]

    def alphaOlq1bar(self, mif1,mif2,mif3,mif4):
        return -3/8 * (self.MVX)**(-2) * self.gVX[mif2,mif3] * self.gVXbar[mif1,mif4]

    def alphaOlq3(self, mif1,mif2,mif3,mif4):
        return 1/8 * (self.MVX)**(-2) * self.gVX[mif1,mif4] * self.gVXbar[mif2,mif3]

    def alphaOlq3bar(self, mif1,mif2,mif3,mif4):
        return 1/8 * (self.MVX)**(-2) * self.gVX[mif2,mif3] * self.gVXbar[mif1,mif4]
